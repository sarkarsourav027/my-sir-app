...
const Header = () => (
    ...
    >
        ...
        />
        <h1 style={{ fontSize: '2rem' }}>Tax Invoice</h1>
    </div>
);
const BillDetails = () => (
    <div
    ...
    >
        <div>
            ...
            <span style={{ color: '#333333' }}>Recepient Name</span>
        </div>
        <div>
            <p style={{ fontWeight: '600' }}>Invoice No:</p>
            <span style={{ color: '#333333' }}>MFSPL/21-22/001</span>
        </div>
        <div>
            <p style={{ fontWeight: '600' }}>Issue Date:</p>
            <span style={{ color: '#333333' }}>January 13, 2022</span>
        </div>
    </div>
);
const lineItemsData = [
...
const Item = ({ item, period, amount }) => (
    ...
    >
        <div>
            <p style={{ fontWeight: '600', color: '#333333' }}>{` ${item} -`}</p>
            <p style={{}}>{` ${period} `}</p>
        </div>
    ...
    <>
        ...
        >
            <div style={{ textAlign: 'right', paddingRight: '4rem' }}>
                ...
                <p style={{ fontWeight: '600', color: '#333333' }}>
          <span style={{ fontWeight: '600', color: '#707070' }}>
            Additional
          </span>{' '}
                    - IGST:
                </p>
            ...
            <div>
                <p style={{ fontWeight: '600', color: '#333333' }}>
                    {`₹ ${indianCurrency.format(12232)} `}
                </p>
                <p style={{ fontWeight: '600', color: '#333333' }}>
                    {`₹ ${indianCurrency.format(2542)} `}
                </p>
            </div>
        </div>
        <div
    ...
    >
        <div>
            ...
            <p style={{ paddingBottom: '0.2rem', color: '#333333' }}>
                ...
                <span style={{ fontWeight: '600' }}>IDFC FIRST BANK</span>
            </p>
            <p style={{ paddingBottom: '0.2rem', color: '#333333' }}>
                <span>Account Number:</span>
                <span style={{ fontWeight: '600' }}>10076297691</span>
            </p>
            <p style={{ paddingBottom: '0.2rem', color: '#333333' }}>
                <span>IFSC CODE:</span>{' '}
                <span style={{ fontWeight: '600' }}>IDFB0040106</span>
            </p>
            <p style={{ paddingBottom: '0.2rem', color: '#333333' }}>
                <span>Branch:</span>
                <span style={{ fontWeight: '600' }}> Nariman Point</span>
            </p>
            <p style={{ paddingBottom: '0.2rem', color: '#333333' }}>
        ...
        >
            <p style={{ fontWeight: '600' }}>
                For Midas Fintech Solutions Private Limited
            </p>
            <Signature />
            ...
            <div className="bg-white">
                ...
                <div className="invoicePages" id="invoicePageOne" style={pageStyle}>
                    ...
                    >
                        ...
                        <p style={{ fontWeight: '600' }}>Amount - INR</p>
                    </div>
