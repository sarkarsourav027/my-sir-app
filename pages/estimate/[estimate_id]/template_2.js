...
const Header = () => (
    ...
    >
        <div>
            <p style={{ fontWeight: '600' }}>SK Tech Systems</p>
            <p style={{ color: '#333333' }}>USA 1</p>
            <p style={{ color: '#333333' }}>1234567</p>
            <p style={{ color: '#333333' }}>info@sktech.com</p>
        </div>
...
const InvoiceTitle = () => (
    <div
        style={{
            padding: '0rem 2rem 1rem 2rem',textAlign: 'center',
        }}
    >
        <div>
    ...
    >
        <div>
            <p style={{ paddingBottom: '0.2rem', color: '#333333' }}>
                ...
                <span style={{ fontWeight: '600' }}>Int Technologies</span>
            </p>
            <p style={{ paddingBottom: '0.2rem', color: '#333333' }}>
                <span style={{ paddingLeft: '4rem', fontWeight: '600' }}>Mumbai, India </span>
            </p>
        </div>
        <div
            style={{
        ...
        >
            <p style={{ paddingBottom: '0.2rem', color: '#333333' }}>
                <span style={{ paddingRight: '4rem'}}>Estimate No:</span>{' '}
                <span style={{ fontWeight: '600' }}>Est #8</span>
            </p>
            <p style={{ paddingBottom: '0.2rem', color: '#333333' }}>
                <span style={{ paddingRight: '1rem'}}>Estimate Date:</span>
                <span style={{ fontWeight: '600' }}>2023-07-25 </span>
            </p>
            <p style={{ paddingBottom: '0.2rem', color: '#333333' }}>
                <span style={{ paddingRight: '1.4rem'}}>Reference No:</span>{' '}
                <span style={{ fontWeight: '600' }}>Template2</span>
            </p>
        </div>
    </div>
...
const Item = ({ description, qty, rate, amount }) => (
    <div
        style={{
            paddingInline: '2rem',
            display: 'flex',
    ...
    >
        ...
        <div>
            <p style={{ fontWeight: '600', color: '#333333' }}>{`₹ ${indianCurrency.format(rate)} `}</p>
        </div>
        <div>
            <p style={{ fontWeight: '600', color: '#333333' }}>{`₹ ${indianCurrency.format(amount)} `}</p>
        </div>
    ...
    <>
        ...
        >
            ...
            <div>
                ...
                <p style={{ fontWeight: '600', color: '#333333' }}>
                    {`₹ ${indianCurrency.format(-1000)} `}
                </p><p style={{ fontWeight: '600', color: '#333333' }}>
                    {`₹ ${indianCurrency.format(11132)} `}
                </p>
                <p style={{ fontWeight: '600', color: '#333333' }}>
                    {`₹ ${indianCurrency.format(555.60)} `}
                </p><p style={{ fontWeight: '600', color: '#333333' }}>
                    {`₹ ${indianCurrency.format(200.0)} `}
                </p>
            </div>
        </div>
        <div
