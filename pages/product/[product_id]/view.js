...
export default function ProductView(details) {
    ...
    const [previewUrl, setPreviewUrl] = useState(details.product_image_path + details.product.image);
                                        ...
                                        <div className="grid gap-6 mb-8 md:grid-cols-2">
                                            <div>
                                                <Input type="text" name="name" value={formData.name}
                                                       lable="Product Name" readOnly/>
                                            </div>
                                            <div>
                                                <Input type="text" name="price" value={formData.price}
                                                       lable="Per Unit Price" readOnly/>
                                            </div>
                                            <div>
                                                <Input type="text" name="minimum" value={formData.minimum}
                                                       lable="Re-order Lavel (Optional)" readOnly/>
                                            </div>
                                            <div>
                                                <SelectInput
                                                    option={
...
export const getServerSideProps = async (context) => {
    ...
    sentFormData.append("product_id", context.params.product_id)
