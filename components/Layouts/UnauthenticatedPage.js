...
export default function UnauthenticatedPage() {
    return (
        <div className="bg-white w-full min-h-screen flex justify-center items-center">
            <div
                className='flex items-center justify-center min-h-screen from-teal-100 via-teal-300 to-teal-500 bg-white'>
                <div className='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
                    <div className='max-w-md mx-auto space-y-6 flex justify-center'>
                        ...
                        <Link href='/pages/sign-in'
                            ...
                            <strong className='font-medium'>Please sign in to access this page.</strong>
                            <svg className="ml-1 rotate-180 fill-white group-hover:fill-blue-500" width="27" height="27"
                            ...
                            <span
                                className='absolute bg-white bottom-0 w-0 left-1/2 h-full -translate-x-1/2 transition-all ease-in-out duration-300 group-hover:w-[105%] -z-[1] group-focus:w-[105%]'></span>
                        </Link>
