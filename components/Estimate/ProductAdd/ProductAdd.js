                                            ...
                                            <table className="min-w-full text-left text-sm font-light border-collapse ">
                                                ...
                                                <tbody>
                                                {
                                                    (()=>{
                                                        ...
                                                        return globalProductList.filteredProductData && globalProductList.filteredProductData.filter((row) =>
                                        ...
                                        <div className="bg-white w-full rounded">
                                            <table className="min-w-full text-left text-sm font-light border-collapse ">
                                                ...
                                                {(()=>{
                                                    ...
                                                    return  globalItemList.filteredProductData && globalItemList.filteredProductData.filter((row) =>
